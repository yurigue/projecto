        ...
        <div class="content">
            <div class="row">
                <div class="col-sm-4 col-3">
                    <h4 class="page-title">Gerir Regime</h4>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-border table-striped custom-table datatable mb-0">
                            ...
                            <tr>
                                ...
                                <th><a href="add_regime_adm.php" style="background-color: #1A2E46; color: #fff;" class="btn account-btn  fa fa-plus blue2_color"  ">Inserir</a></th>
                            ...
                            $regime= 'SELECT *  FROM regime ' ;
                            if($resultado=$link->query($regime)){
            ...
            <td><a href="eliminar_regime_adm.php?ID_regime='.$row['ID_regime'].'"  class="  fa fa-trash-o red_color"> Eliminar</a></td>
            <td><a href="editar_regime_adm.php?id='.$row['ID_regime'].'" class="fa fa-wrench green_color"> Editar</a></td>
