...
<div class="main-wrapper">
    ...
    <div class="page-wrapper">
        <div class="content">
                    ...
                    <div class="table-responsive">
                        <table class="table table-border table-striped custom-table datatable mb-0">
                            ...
                            <tr>
                                ...
                                <th><a href="add_area_adm.php" style="background-color: #1A2E46; color: #fff;" class="btn account-btn  fa fa-plus blue2_color"  ">Inserir</a></th>
            ...
            <td><a href="eliminar_area_adm.php?ID_area='.$row['ID_area'].'"  class="  fa fa-trash-o red_color"> Eliminar</a></td>
            <td><a href="editar_area_adm.php?id='.$row['ID_area'].'" class="fa fa-wrench green_color"> Editar</a></td>
