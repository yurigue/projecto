                ...
                <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                    <div class="dash-widget">
                        ...
                        <div class="dash-widget-info text-right">
                            ...
                            $query ="SELECT ID_utilizador FROM utilizador ORDER BY ID_utilizador ";
                            $query_run = mysqli_query($link, $query);
                            $row =mysqli_num_rows($query_run);
                            echo' <h3> '.$row.'</h3>';
                            ?>
                            <span class="widget-title1"> Total de Candidatos<i class="fa fa-check" aria-hidden="true"></i></span>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                    <div class="dash-widget">
                        <span class="dash-widget-bg2"></span>
                        <div class="dash-widget-info text-right">
                            <?php

                            $query ="SELECT ID_area FROM area ORDER BY ID_area ";
                            $query_run = mysqli_query($link, $query);
                            $row =mysqli_num_rows($query_run);
                            echo' <h3> '.$row.'</h3>';
                            ?>
                            <span class="widget-title2">Total de Áreas<i class="fa fa-check" aria-hidden="true"></i></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                    <div class="dash-widget">
                        ...
                        <div class="dash-widget-info text-right">
                            ...
                            $query ="SELECT ID_oferta FROM oferta ORDER BY ID_oferta ";
                            $query_run = mysqli_query($link, $query);
                            $row =mysqli_num_rows($query_run);
                            echo' <h3> '.$row.'</h3>';
                            ?>
                            <span class="widget-title4">Total de Ofertas <i class="fa fa-check" aria-hidden="true"></i></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                    <div class="dash-widget">
                        ...
                        <div class="dash-widget-info text-right">
                            ...
                            $query ="SELECT ID_candidatura FROM candidatura ORDER BY ID_candidatura ";
                            $query_run = mysqli_query($link, $query);
                            $row =mysqli_num_rows($query_run);
                            echo' <h3> '.$row.'</h3>';
                            ?>
                            <span class="widget-title3">Total de Candidaturas <i class="fa fa-check" aria-hidden="true"></i></span>
                        </div>
                    </div>
                </div>
