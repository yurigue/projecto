...
<div class="main-wrapper">
    <div class="header" style="background-color:#1A2E46">
        <div class="header-left">
            <a href="../index.php" class="logo">
                <img src="../imagem/ajuda.png" width="120" height="40" alt=""> <span>AJUDA.EMPREGOS</span></a>
        </div>
    ...
    <form method="POST" action="proc_adm.php" enctype="multipart/form-data">
        <div class="page-wrapper">
            <div class="content">
                <div class="row">
                    ...
                    <input type="submit" style="background-color: #1A2E46; color: #fff; border-radius: 35px; border: none; width: 120px; height: 40px; cursor: pointer;"  value="Carregar">
                </div>
