        ...
        <div class="content">
            <div class="row">
                <div class="col-sm-4 col-3">
                    <h4 class="page-title">Candidaturas</h4>
                </div>
                ...
                <div class="col-md-12">
                    <div class="table-responsive">
                        <table class="table table-border table-striped custom-table datatable mb-0">
                            ...
                            $candida_1="SELECT candidatura.*, utilizador.* , oferta.*, estado_candidatura.*   FROM candidatura inner join utilizador on candidatura.Utilizador_ID_utilizador = utilizador.ID_utilizador inner join oferta on candidatura.Oferta_ID_oferta = oferta.ID_oferta inner join estado_candidatura on candidatura.Estado_candidatura_ID_estado = estado_candidatura.ID_estado ";
            ...
            <td><img width="28" height="28" src="../imagem/'.$row['Imagem'].'" class="rounded-circle m-r-5" alt=""> '.$row['Nome'].'</td>
              ...
              <td>'.$row['Email'].'</td>
               <td>'.$row['Telefone'].'</td>
                <td><a target="_blank" href="../CV/'.$row['CV'].'"> Obter (CV)<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-download" viewBox="0 0 16 16">
  ...
  <path d="M7.646 11.854a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293V1.5a.5.5 0 0 0-1 0v8.793L5.354 8.146a.5.5 0 1 0-.708.708l3 3z"/>
          ...
          <td>'.$row['Titulo'].'</td>
           ...
           <td>'.$row['Estado_Estado'].'</td>
            ...
            <td><a href="eliminar_candidatura_adm.php?ID_candidatura='.$row['ID_candidatura'].'"  class="  fa fa-trash-o red_color"> Eliminar</a></td>
            <td><a href="editar_candidatura_adm.php?ID_candidatura='.$row['ID_candidatura'].'" class="fa fa-wrench green_color"> Alterar</a></td> 
