    ...
    <div class="page-wrapper">
        <div class="content">
                    ...
                    <div class="table-responsive">
                        <table class="table table-border table-striped custom-table datatable mb-0">
                            ...
                            <tr>
                                ...
                                <th><a href="add_oferta.php" style="background-color: #1A2E46; color: #fff;" class="btn account-btn  fa fa-plus blue2_color"  ">Inserir</a></th>
                            ...
                            $utilizador="SELECT oferta.*, area.*, tipo_oferta.* , local.*, estado_oferta.*, regime.*, utilizador.*  FROM oferta  inner join area on oferta.Area_ID_area = area.ID_area inner join tipo_oferta on oferta.Tipo_oferta_ID_tipo = tipo_oferta.ID_tipo inner join local on oferta.Local_ID_local = local.ID_local inner join estado_oferta on oferta.Estado_oferta_ID_estado= estado_oferta.ID_estado inner join regime on oferta.Regime_ID_regime= regime.ID_regime inner join utilizador on oferta.Utilizador_ID_utilizador= utilizador.ID_utilizador";
          ...
          <td>'.$row['Titulo'].'</td>
            ...
            <td><a href="editar_oferta_adm.php?ID_oferta='.$row['ID_oferta'].'" class="fa fa-wrench green_color"> Alterar</a></td>
