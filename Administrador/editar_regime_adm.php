...
<div class="main-wrapper">
    ...
    /* texto sql da sql*/
    $editar = "SELECT * FROM Regime  WHERE ID_regime = '$id' ";
        ...
        <div class="content">
            <div class="row">
                <div class="col-sm-7 col-6">
                    <h4 class="page-title">Alteração de regime</h4>
                </div>
                <form action="edit_regime_adm.php" method="post" >
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-9">
                                                            <div class="form-group">
                                                                ...
                                                                <input name="c_Regime" class="form-control" type="text" value="<?=$row['Regime']?>">
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-9">
                                                            <div class="form-group">
                                                                <input name="c_idRegime" class="form-control" type="text" value="<?=$row['ID_regime']?>">
                                                            </div>
                                                        </div>
