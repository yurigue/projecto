        ...
        <div class="content">
            <div class="row">
                <div class="col-sm-4 col-3">
                    <h4 class="page-title">Gerir Habilitação</h4>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-border table-striped custom-table datatable mb-0">
                            ...
                            <tr>
                                ...
                                <th><a href="add_habilitacao_adm.php" style="background-color: #1A2E46; color: #fff;" class="btn account-btn  fa fa-plus blue2_color"  ">Inserir</a></th>
                            ...
                            $habilitacao= 'SELECT *  FROM habilitacao ' ;
            ...
            <td><a href="elimininar_habilitacao_adm.php?ID_habilitacao='.$row['ID_habilitacao'].'"  class="  fa fa-trash-o red_color"> Eliminar</a></td>
            <td><a href="editar_habilitacao_adm.php?id='.$row['ID_habilitacao'].'" class="fa fa-wrench green_color"> Editar</a></td>
