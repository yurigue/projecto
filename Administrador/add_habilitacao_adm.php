...
<div class="main-wrapper">
    ...
    <div class="page-wrapper">
        <div class="content">
            ...
            $link->close();
            ?>
            <form method="POST" action="ad_habilitacao_adm.php" onSubmit="return validar()">
                            ...
                            <div class="row">
                                <div class="col-md-5">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="q_Habilitacao" name="q_Habilitacao"  class="form-control >
                                </div>
<button style="background-color: #34512A; color: #fff" class="btn account-btn" type="submit">Submeter</button>
            ...
            <script src="../assets/js/bootstrap.min.js">
                ...
                function validar() {
                    ...
                    var area = document.getElementById("Habilitacao").value;
                    if (Habilitacao=="") {
                        document.getElementById("Habilitacao").setCustomValidity("Preencha a Categoria de Habilitação!");
