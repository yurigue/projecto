        ...
        <div class="content">
            <div class="row">
                <div class="col-sm-7 col-6">
                    <h4 class="page-title">Inserir Regime</h4>
                </div>
            ...
            $link->close();
            ?>
            <form method="POST" action="ad_regime_adm.php" onSubmit="return validar()">
                            ...
                            <div class="row">
                                <div class="col-md-5">
                                    ...
                                    <div class="form-group">
                                        <label>Regime</label>
                                        <input type="text" id="q_Regime" name="q_Regime"  class="form-control >
                                </div>
<button style="background-color: #34512A; color: #fff" class="btn account-btn" type="submit">Submeter</button>
            ...
            <script src="../assets/js/bootstrap.min.js">
                ...
                function validar() {
                    ...
                    var area = document.getElementById("Regime").value;
                    if (Regime=="") {
                        document.getElementById("Regime").setCustomValidity("Preencha a Categoria de Produto!");
