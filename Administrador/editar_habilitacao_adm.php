...
<div class="main-wrapper">
    ...
    /* texto sql da sql*/
    $editar = "SELECT * FROM Habilitacao  WHERE ID_habilitacao = '$id' ";
        ...
        <div class="content">
            <div class="row">
                <div class="col-sm-7 col-6">
                    <h4 class="page-title">Alteração Habilitação</h4>
                </div>
                <form action="edit_habilitacao_adm.php" method="post" >
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-10">
                                                            <div class="form-group">
                                                                ...
                                                                <input name="c_Habilitacao" class="form-control" type="text" value="<?=$row['Habilitacao']?>">
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-9">
                                                            <div class="form-group">
                                                                <input name="c_idHabilitacao" class="form-control" type="text" value="<?=$row['ID_habilitacao']?>">
                                                            </div>
                                                        </div>
