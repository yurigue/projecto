                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="custom-select d-block w-100"  name="a_Tipo_oferta_ID_tipo" >
                                                            ...
                                                            <div class="col-sm-9">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="custom-select d-block w-100"  name="a_Estado_IDestado" >
                                                            ...
                                                            <div class="col-sm-9">
                                                                <div class="form-group">
                                                                    <label>Regime</label>
                                                                    <select class="custom-select d-block w-100"  name="a_Regime_ID_regime" >
