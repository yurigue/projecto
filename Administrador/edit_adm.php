...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $Bi= filter_input(INPUT_POST, 'y_Bi');
...
$Edit ="UPDATE utilizador SET Username='$username', Nome='$Nome', Email= '$Email', Telefone='$Telefone',Morada='$Morada',Localidade='$Localidade' ,Codigo_Postal='$Codigo_Postal',Nif='$Nif' ,Bi='$Bi' WHERE ID_utilizador = '$id'";
