                ...
                <div class="account-box">
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" class="form-signin">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="Username" class="form-control" placeholder="Insira um nome de utilizador" <?php echo (!empty($username_err)) ? 'is-invalid' : ''; ?>" id="<?php echo $username; ?>">
                        </div>
                        <div class="form-group">
                            <label>Email</label>
                        ...
                        <div class="text-center login-link">
                            Já tens a conta? <a style="color: #000000" href="../Login/login.php">Login</a>
                        </div>
                    </form>
                </div>
            </div>
