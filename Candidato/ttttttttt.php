        ...
        <div class="sidebar-inner slimscroll">
            <div class="sidebar-menu">
                <ul>
                    ...
                    <li>
                        <a href="email-settings.html"><i class="fa fa-envelope-o"></i> <span>username Settings</span></a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="../Utilizador/Candidato/change-password.html"><i class="fa fa-lock"></i> <span>Change Password</span></a>
                    </li>
                    <li>
