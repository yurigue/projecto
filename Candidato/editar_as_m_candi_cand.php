...
<div class="main-wrapper">
    ...
    <div class="page-wrapper">
        ...
        $catc  = "SELECT  candidatura.*, oferta.*, estado_candidatura.* FROM candidatura  inner join oferta on candidatura.Oferta_ID_oferta = oferta.ID_oferta inner join estado_candidatura on candidatura.Estado_candidatura_ID_estado= estado_candidatura.ID_estado  WHERE  ID_candidatura IN (".$idyx.")";
        ...
        if($resultado=$link->query($catc)){
            ...
            <div class="profile-tabs">
                <ul class="nav nav-tabs nav-tabs-bottom">
                   ...
                   <form action="edit_as_m_candi_cand.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12">
                                <div class="card-box">
                                    ...
                                    <div class="experience-box">
                                        <textarea type="text" style="width: 55%;" name="i_Mensagem"  cols="20" rows="10">'.$row['Mensagem'].'</textarea>
                                    </div>
                                    <div class="experience-box">
                                        <textarea type="text" style="width: 10%;" name="i_ID_candidatura" cols="1" rows="1">' .$idyx.'</textarea>
