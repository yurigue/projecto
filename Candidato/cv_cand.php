        ...
        <div class="content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="table-responsive">
                        <table class="table table-border table-striped custom-table datatable mb-0">
                            ...
                            <tr>
                                ...
                                <th><a href="inserir_cv.php" style="background-color: #1A2E46; color: #fff; border-radius: 35px; border: none; width: 120px; cursor: pointer;" class="btn account-btn  fa fa-plus blue2_color" >Adicionar</a></th>
                 ...
                 <td><a style="color: #1A2E46" target="_blank" href="../CV/'.$row['CV'].'"> Obter (CV) <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-download" viewBox="0 0 16 16">
