...
<div class="main-wrapper">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "GET") {
        ...
        if (empty($ID_utilizador) && $operacao!="editar"){
    ...
    /* definir o charset utilizado na ligação */
    $link->set_charset("utf8");
    $id_13=$_SESSION["ID_utilizador"];
    /* texto sql da sql*/
    $editar = "SELECT utilizador.*, habilitacao.*  FROM utilizador inner join habilitacao on utilizador.Habilitacao_ID_habilitacao = habilitacao.ID_habilitacao  WHERE ID_utilizador = '$id_13' ";
        ...
        <div class="content">
            <div class="row">
                <div class="col-sm-7 col-6">
                    <h4 class="page-title">Inserir Habilitação </h4>
                </div>
                <form action="edit_habilitacao_cand.php" method="post" >
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-25">
                                                            <div class="form-group">
                                                                <label>Habilitação <span class="text-danger"></span></label>
                                                                <select class="custom-select d-block w-100"  name="ha_Habilitacao_ID_habilitacao" >

                                                                    <option value=<?=$row['ID_habilitacao']?> selected><?= $row['Habilitacao']?></option>
                                                                    <?php
                                                                    require("../config.php");
                                                                    $link->set_charset("utf8");
                                                                    $tp=$row['ID_habilitacao'];
                                                                    $consulta = "SELECT * FROM habilitacao where ID_habilitacao!=$tp";
                                                                    ...
                                                                    if (!$resultado = $link->query($consulta)) {
                                                                        ...
                                                                        while ($rowss = $resultado->fetch_assoc()) {
                                                                            ...
                                                                            ?>
                                                                            <option value=<?= $rowss['ID_habilitacao']?>><?= $rowss['Habilitacao']?></option>
                                                                            <?php
                                                                        }
                                                        ...
                                                        <div class="col-sm-9">
                                                            <div class="form-group">
                                                                <input name="ha_ID_utilizador" class="form-control" type="text" value="<?=$row['ID_utilizador']?>">
                                                            </div>
                                                        </div>
