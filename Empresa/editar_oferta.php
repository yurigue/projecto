    ...
    <div class="page-wrapper">
        ...
        <div class="content">
            <div class="row">
                ...
                <form method="post" action="edit_oferta.php">

                    <button style="background-color: #1A2E46; color: #fff;" class="btn account-btn" type="submit">Guardar Alteracoes</button>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="custom-select d-block w-100"  name="e_Tipo_oferta_ID_tipo" >
                                                                        ...
                                                                        $link->set_charset("utf8");
                                                                        $tp=$row['ID_tipo'];
                                                                        $consulta = "SELECT * FROM tipo_oferta where ID_tipo!=$tp";
                                                            ...
                                                            <div class="col-sm-9">
                                                                <div class="form-group">
                                                                    <label>Estado da oferta</label>
                                                                    <select class="custom-select d-block w-100"  name="e_Estado_oferta_ID_estado" >
                                                                        ...
                                                                        $link->set_charset("utf8");
                                                                        $tp=$row['ID_estado'];
                                                                        $consulta = "SELECT * FROM estado_oferta where ID_estado!=$tp";
                                                                        ...
                                                                        if (!$resultado = $link->query($consulta)) {
                                                                            ...
                                                                            while ($rowss = $resultado->fetch_assoc()) {
                                                                                ...
                                                                                ?>
                                                                                <option value=<?= $rowss['ID_estado']?>><?= $rowss['Estado']?></option>
                                                                                <?php
                                                                            }
                                                            ...
                                                            <div class="col-sm-9">
                                                                <div class="form-group">
                                                                    <label>Regime</label>
                                                                    <select class="custom-select d-block w-100"  name="e_Regime_ID_regime" >

                                                                        <option value=<?=$row['ID_regime']?> selected><?= $row['Regime']?></option>
                                                                        <?php
                                                                        require("../config.php");
                                                                        $link->set_charset("utf8");
                                                                        $ep=$row['ID_regime'];
                                                                        $consulta = "SELECT * FROM regime where ID_regime!=$ep";
                                                                        ...
                                                                        if (!$resultado = $link->query($consulta)) {
                                                                            ...
                                                                            while ($rowss = $resultado->fetch_assoc()) {
                                                                                ...
                                                                                ?>
                                                                                <option value=<?= $rowss['ID_regime']?>><?= $rowss['Regime']?></option>
                                                                                <?php
                                                                            }
