    ...
    <div class="page-wrapper">
        <div class="content">
                    ...
                    <div class="table-responsive">
                        <table class="table table-border table-striped custom-table datatable mb-0">
                            ...
                            <tr>
                                ...
                                <th><a href="inserir_oferta.php" style="background-color: #1A2E46; color: #fff;" class="btn account-btn  fa fa-plus blue2_color"  ">Inserir</a></th>
          ...
          <td>'.$row['Titulo'].'</td>
            ...
            <td><a href="eliminar_oferta.php?ID_oferta='.$row['ID_oferta'].'"  class="  fa fa-trash-o red_color"> Eliminar</a></td>
            <td><a href="editar_oferta.php?ID_oferta='.$row['ID_oferta'].'" class="fa fa-wrench green_color"> Alterar</a></td>
