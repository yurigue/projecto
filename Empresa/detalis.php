...
<div class="main-wrapper">
    <div class="header" style="background-color:#1A2E46">
        ...
        <ul class="nav user-menu float-right">
            <ul class="nav user-menu float-right">
                <?php
                $id_112=$_SESSION["ID_utilizador"];
                $query ="SELECT * FROM candidatura  WHERE (Estado_candidatura_ID_estado='1' or Estado_candidatura_ID_estado='2')  and (Utilizador_ID_utilizador='$id_112' and visitado='0' )  ORDER BY ID_candidatura DESC";
